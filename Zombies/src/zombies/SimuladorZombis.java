...
public class SimuladorZombis {
	...
	public static void main(String[] args) {
		...
		System.out.println("---SIMULADOR PELEAS ZOMBIES---");
		        ...
		        System.out.println("4. ZombiTanque");

		        System.out.print("\nSelecciona el número del zombi: ");
		        int eleccion1 = sc.nextInt();

		        Zombi zombi1 = crearZombi(eleccion1);

		        System.out.println("\nElige el tipo de zombi para el Jugador 2:");
		        System.out.println("1. ZombiCaminante");
		        System.out.println("2. ZombiCorredor");
		        System.out.println("3. ZombiSaltarin");
		        System.out.println("4. ZombiTanque");
		        ...
		        if (zombi1.estaVivo()) {
		            System.out.println("\nZombi 1 gana la pelea!");
		        } else if (zombi2.estaVivo()) {
		            System.out.println("\nZombi 2 gana la pelea!");
		        } else {
		            System.out.println("\nAmbos zombis han caído en combate.");
		        }
